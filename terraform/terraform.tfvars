...
###########################################
create_sg = true
sg_names  = ["bastion-sg", "application-sg"]
...
bastion_ami_id          = "ami-0360c520857e3138f" # RHEL 9.x AMI (example, update as per region)
bastion_instance_type   = "t2.micro"
bastion_subnet_index    = 0
bastion_sg_name         = "bastion-sg"
bastion_key_name        = "new-key"
...
private_instance_ami_id     = "ami-0fd3ac4abb734302a" # RHEL 9.x AMI (same or different)
private_instance_type       = "t3.micro"
private_instance_subnet     = 1
private_instance_sg_name    = "application-sg"
private_instance_key        = "new-key"
